...
{
    class MiniPumpkin : Collectable
    {
        public MiniPumpkin(Position position, Spacemap spacemap, bool respawnable, Player toPlayer = null) : base(AssetTypeModule.BOXTYPE_MINI_PUMPKIN, position, spacemap, respawnable, toPlayer) { }
        ...
        {
            return CreateBoxCommand.write("MINI_PUMPKIN", Hash, Position.Y, Position.X);
        }
    }
}
