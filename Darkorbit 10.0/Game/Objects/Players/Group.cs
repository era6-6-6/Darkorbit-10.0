...
namespace Darkorbit.Game.Objects
{
    class Group : Tick
    {
        ...
        public const int DEFAULT_MAX_GROUP_SIZE = 14;
        ...
        public void InitializeGroup(Player player)
        {
            try
            {
                ...
                player.SendCommand(GroupInitializationCommand.write(player.Id, 0, player.Group.Leader.Id, groupMembers, new GroupInvitationBehaviorModule(LeaderInvitesOnly ? GroupInvitationBehaviorModule.ON : GroupInvitationBehaviorModule.OFF)));
        ...
        public void Destroy()
        {
            EventManager.groupEvent.RemoveWaitingPlayer(Leader);
