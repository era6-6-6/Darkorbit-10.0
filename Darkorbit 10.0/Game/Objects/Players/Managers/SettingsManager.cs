global using Darkorbit.Managers;
using Darkorbit.Game.Events;
using Darkorbit.Game.Objects.Mines;

namespace Darkorbit.Game.Objects.Players.Managers
{
    public class bootyKeys
    {
    ...
    public class positionInitializacion
    {
        public int mapID = 0;
    ...
    public class EquipmentBase
    {
        ...
        public bootyKeys Items = new bootyKeys();
        public int Lasers = 0;

        public EquipmentBase(ConfigsBase configs, bootyKeys items)
        {
            Configs = configs;
            Items = items;
        }
    ...
    public class WindowBase
    {
        ...
        public Dictionary<string, Window> windows = new Dictionary<string, Window>()
        {
            ...
            { "refinement", new Window(50, 50, 450, 520, false) },
            { "quests", new Window(30, 30, 200, 150, false) },
            { "pet", new Window(50, 50, 260, 130, false) },
            { "spaceball", new Window(10, 10, 170, 70, false) },
            { "invasion", new Window(10, 10, 170, 80, false) },
            { "tdm", new Window(10, 10, 170, 70, false) },
            { "ctb", new Window(50, 0, 160, 160, false) },
    ...
    public class InGameSettingsBase
    {
        ...
        public string selectedRocket = AmmunitionManager.PLT_3030;
    ...
    class SettingsManager : AbstractManager
    {
        ...
        {
                AmmunitionManager.LCB_10, AmmunitionManager.MCB_25, AmmunitionManager.MCB_50, //AmmunitionManager.MCB_100,
                //AmmunitionManager.MCB_250,
                AmmunitionManager.UCB_100, AmmunitionManager.SAB_50, //AmmunitionManager.CBO_100,
                AmmunitionManager.RSB_75 //AmmunitionManager.MCB_500 //AmmunitionManager.RB_214, AmmunitionManager.JOB_100
        };

        public static string[] RocketsCategory =
              {
                "ammunition_rocket_r-310", "ammunition_rocket_plt-2026", "ammunition_rocket_plt-2021",
                "ammunition_rocket_plt-3030", "ammunition_specialammo_dcr-250",// "ammunition_specialammo_wiz-x",
                "ammunition_specialammo_pld-8" //"ammunition_rocketlauncher_hstrm-01", "ammunition_rocketlauncher_eco-10", "ammunition_rocketlauncher_sar-02" //"ammunition_specialammo_r-ic3"
               // , "ammunition_rocket_bdr-1211"
        };

        public static string[] RocketLauncherCategory =
        {
                CpuManager.ROCKET_LAUNCHER, "ammunition_rocketlauncher_hstrm-01", "ammunition_rocketlauncher_eco-10",
                //"ammunition_rocketlauncher_ubr-100", "ammunition_rocketlauncher_cbr",//"ammunition_rocketlauncher_bdr1212",
        ...
        {
                DroneManager.DEFAULT_FORMATION,
                DroneManager.TURTLE_FORMATION,
                DroneManager.ARROW_FORMATION,
                DroneManager.LANCE_FORMATION,
                DroneManager.BARRAGE_FORMATION,
                DroneManager.DOME_FORMATION,
                DroneManager.RING_FORMATION,
                DroneManager.VETERAN_FORMATION,
                DroneManager.BAT_FORMATION,
                DroneManager.STAR_FORMATION,
                DroneManager.PINCER_FORMATION,
                DroneManager.DOUBLE_ARROW_FORMATION,
                DroneManager.DIAMOND_FORMATION,
                DroneManager.CHEVRON_FORMATION,
                DroneManager.MOTH_FORMATION,
                DroneManager.CRAB_FORMATION,
                DroneManager.HEART_FORMATION,
                DroneManager.DRILL_FORMATION,
                DroneManager.WHEEL_FORMATION,
                DroneManager.WAVE_FORMATION,
                DroneManager.X_FORMATION
        };
        ...
        public void SendUserSettingsCommand()
        {
            ...
            Player.SendCommand(UserSettingsCommand.write(
                ...
                new GameplaySettingsModule(gameplaySettings.notSet, gameplaySettings.autoBoost, gameplaySettings.autoRefinement, gameplaySettings.quickSlotStopAttack, gameplaySettings.doubleclickAttackEnabled, gameplaySettings.autochangeAmmo, gameplaySettings.extraSettings.ToString(), gameplaySettings.autoBuyBootyKeys, false, gameplaySettings.varE3N),
        ...
        public void SendMenuBarsCommand()
        {
            ...
            leftItems.Add("ctb", "title_ctb");
            leftItems.Add("tdm", "title_tdm");*/
            if (Player.Pet != null)
            ...
            if (EventManager.Invasion.Started)
                leftItems.Add("invasion", "title_invasion");
            if (EventManager.UbaEvent)
                leftItems.Add("traininggrounds", "title_traininggrounds");

            if (Player.BoosterManager.checkIfIssetBoosters())
        ...
        public void SendSlotBarCommand()
        {
            ...
            if (Player.Settings.Display.showPremiumQuickslotBar)
        ...
        public ClientUISlotBarCategoryModule GetLasersCategory()
        {
            ...
            foreach (string itemLootId in LaserCategory)
            {
                ...
                lasersItems.Add(new ClientUISlotBarCategoryItemModule(1, GetItemStatus(itemLootId, "ttip_laser", Player.AmmunitionManager.GetAmmo(itemLootId), true, true, false, visible),
    ...
    new ClientUISlotBarCategoryItemTimerModule(GetCooldownTime(itemLootId),
                ...
                rocketItems.Add(new ClientUISlotBarCategoryItemModule(1, GetItemStatus(itemLootId, "ttip_rocket", Player.AmmunitionManager.GetAmmo(itemLootId), true, true),
                                                                      ClientUISlotBarCategoryItemModule.SELECTION,
                                                                      ClientUISlotBarCategoryItemModule.BAR,
                                                                      GetCooldownType(itemLootId),
                                                                      categoryTimerModule));
      ...
      new ClientUISlotBarCategoryItemTimerModule(GetCooldownTime(itemLootId),
                 ...
                 rocketLauncherItems.Add(new ClientUISlotBarCategoryItemModule(1, GetItemStatus(itemLootId, "ttip_rocketlauncher", Player.AmmunitionManager.GetAmmo(itemLootId), true, true),
                                                                       ClientUISlotBarCategoryItemModule.SELECTION,
                                                                       ClientUISlotBarCategoryItemModule.BAR,
                                                                       GetCooldownType(itemLootId),
                                                                       categoryTimerModule));
        ...
        /*public ClientUISlotBarCategoryModule GetRocketLauncherCategory()
        {
            ...
            foreach (string itemLootId in RocketLauncherCategory)
            {
                ...
                rocketLauncherItems.Add(new ClientUISlotBarCategoryItemModule(1, itemLootId == CpuManager.ROCKET_LAUNCHER ? GetRocketLauncherItemStatus(CpuManager.ROCKET_LAUNCHER, "ttip_rocketlauncher", Player.AttackManager.RocketLauncher.CurrentLoad, false) : GetItemStatus(itemLootId, "ttip_rocket", Player.AmmunitionManager.GetAmmo(itemLootId)),
                                                                       ClientUISlotBarCategoryItemModule.BAR,
        ...
        public ClientUISlotBarCategoryModule GetSpecialAmmoCategory()
        {
            ...
            foreach (string itemLootId in SpecialItemsCategory)
            {
                ...
                specialAmmoItems.Add(new ClientUISlotBarCategoryItemModule(1, GetItemStatus(itemLootId, "ttip_explosive", Player.AmmunitionManager.GetAmmo(itemLootId)),
                                                                      ClientUISlotBarCategoryItemModule.SELECTION,
                                                                      ClientUISlotBarCategoryItemModule.BAR,
                                                                      GetCooldownType(itemLootId),
                                                                      categoryTimerModule));
        ...
        public ClientUISlotBarCategoryModule GetMineCategory()
        {
            ...
            foreach (string itemLootId in MinesCategory)
            {
                ...
                mineItems.Add(new ClientUISlotBarCategoryItemModule(1, GetItemStatus(itemLootId, "ttip_explosive", Player.AmmunitionManager.GetAmmo(itemLootId)),
                                                                      ClientUISlotBarCategoryItemModule.SELECTION,
                                                                      ClientUISlotBarCategoryItemModule.BAR,
                                                                      GetCooldownType(itemLootId),
                                                                      categoryTimerModule));
        ...
        public ClientUISlotBarCategoryModule GetCpuCategory()
        {
            ...
            foreach (string itemLootId in CpusCategory)
            {
                ...
                cpuItems.Add(new ClientUISlotBarCategoryItemModule(1, GetItemStatus(itemLootId, GetCpuTtip(itemLootId), Player.AmmunitionManager.GetAmmo(GetCpuTtip(itemLootId)), false),
                                                                      ClientUISlotBarCategoryItemModule.SELECTION,
                                                                      ClientUISlotBarCategoryItemModule.BAR,
                                                                      GetCooldownType(itemLootId),
                                                                      categoryTimerModule));
        ...
        public ClientUISlotBarCategoryModule GetTechCategory()
        {
            ...
            foreach (string itemLootId in TechsCategory)
            {
                ...
                techItems.Add(new ClientUISlotBarCategoryItemModule(1, GetItemStatus(itemLootId, GetTechTtip(itemLootId), 9999, false, false, false, true, blocked),
                                                                      ClientUISlotBarCategoryItemModule.SELECTION,
        ...
        public ClientUISlotBarCategoryModule GetFormationCategory()
        {
            ...
            foreach (string itemLootId in FormationsCategory)
            {
                ...
                if (itemLootId == Player.DEFAULT_FORMATION)
                {
                    visible = false;
                }
                else if (itemLootId == Player.ARROW_FORMATION)
                {
                    visible = true;
                }
                else if (itemLootId == Player.BARRAGE_FORMATION)
                {
                    visible = true;
                }
                else if (itemLootId == Player.BAT_FORMATION)
                {
                    visible = true;
                }
                else if (itemLootId == Player.CHEVRON_FORMATION)
                {
                    visible = true;
                }
                else if (itemLootId == Player.CRAB_FORMATION)
                {
                    visible = true;
                }
                else if (itemLootId == Player.DIAMOND_FORMATION)
                {
                    visible = true;
                }
                else if (itemLootId == Player.DOME_FORMATION)
                {
                    visible = true;
                }
                else if (itemLootId == Player.DOUBLE_ARROW_FORMATION)
                {
                    visible = true;
                }
                else if (itemLootId == Player.DRILL_FORMATION)
                {
                    visible = true;
                }
                else if (itemLootId == Player.HEART_FORMATION)
                {
                    visible = true;
                }
                else if (itemLootId == Player.LANCE_FORMATION)
                {
                    visible = true;
                }
                else if (itemLootId == Player.MOTH_FORMATION)
                {
                    visible = true;
                }
                else if (itemLootId == Player.PINCER_FORMATION)
                {
                    visible = true;
                }
                else if (itemLootId == Player.RING_FORMATION)
                {
                    visible = true;
                }
                else if (itemLootId == Player.STAR_FORMATION)
                {
                    visible = true;
                }
                else if (itemLootId == Player.TURTLE_FORMATION)
                {
                    visible = true;
                }
                else if (itemLootId == Player.VETERAN_FORMATION)
                {
                    visible = true;
                }
                else if (itemLootId == Player.WAVE_FORMATION)
                {
                    visible = true;
                }
                else if (itemLootId == Player.WHEEL_FORMATION)
                {
                    visible = true;
                }
                else if (itemLootId == Player.X_FORMATION)
                {
                    visible = true;
                }
                ...
                if (visible)
                {
                    ...
                    formationItems.Add(new ClientUISlotBarCategoryItemModule(1, GetItemStatus(itemLootId, GetFormationTtip(itemLootId), 0, false, false, false, true),
                                                                          ClientUISlotBarCategoryItemModule.SELECTION,
                                                                          ClientUISlotBarCategoryItemModule.NONE,
                                                                          GetCooldownType(itemLootId),
                                                                          categoryTimerModule));
        ...
        public string GetFormationTtip(string itemId)
        {
            switch (itemId)
            {
                ...
                case DroneManager.DOME_FORMATION:
                    return "ttip_btn_droneFormation_DOME";
        ...
        private long GetCooldownTime(string pItemId)
        {
            switch (pItemId)
            {
                ...
                case AmmunitionManager.PLT_3030:
                    ...
                    return (int)((Player.Premium ? 1000 : 1000) - rocketCooldown);
                case AmmunitionManager.DCR_250:
                ...
                case AmmunitionManager.ISH_01:
                    ...
                    return (int)(30000 - ishCooldown);
                    var ishCooldownSkill = (DateTime.Now - Player.AttackManager.IshCooldown).TotalMilliseconds;
                    return (int)(30000 - ishCooldown);
                case AmmunitionManager.EMP_01:
        ...
        public ClientUISlotBarCategoryItemStatusModule GetRocketLauncherItemStatus(string pItemId, string pTooltipId, int count = 5, bool descriptionEnabled = true, bool doubleClickToFire = false)
        {
        ...
        public void SendNewItemStatus(string itemId)
        {
            ...
            {
                Player.SendCommand(GetNewItemStatus(itemId, "ttip_laser", Player.AmmunitionManager.GetAmmo(itemId), true, true, false));
            }
            else if (RocketsCategory.Contains(itemId))
            {
                Player.SendCommand(GetNewItemStatus(itemId, "ttip_rocket", Player.AmmunitionManager.GetAmmo(itemId), true, true, false));
            }
            else if (CpusCategory.Contains(itemId))
            {
                Player.SendCommand(GetNewItemStatus(itemId, GetCpuTtip(itemId), Player.AmmunitionManager.GetAmmo(itemId), false, false, false));
            }
            else if (FormationsCategory.Contains(itemId))
            {
                Player.SendCommand(GetNewItemStatus(itemId, GetFormationTtip(itemId), Player.AmmunitionManager.GetAmmo(itemId), false, false, false));
            }
            ...
            else
            {
                ...
                {
                    case AmmunitionManager.EMP_01:
                        Player.SendCommand(GetNewItemStatus(itemId, "ttip_explosive", Player.AmmunitionManager.GetAmmo(itemId), true, true, false));
                        break;
                    case AmmunitionManager.SMB_01:
                        Player.SendCommand(GetNewItemStatus(itemId, "ttip_explosive", Player.AmmunitionManager.GetAmmo(itemId), true, true, false));
                        break;
                    case AmmunitionManager.ISH_01:
                        ...
                        break;
                    case CpuManager.CLK_XL:
                        Player.SendCommand(GetNewItemStatus(itemId, "ttip_cloak_cpu", Player.AmmunitionManager.GetAmmo(itemId), true, true, false));
                        break;
                }
            }
        }
        ...
        public void UseSlotBarItem(string pItemId)
        {
            ...
            {
                if (pItemId == AmmunitionManager.RSB_75 && Player.AttackManager.lastRSBAttackTime.AddSeconds(3) >= DateTime.Now)
                {
                }
                else
        ...
        public void SetSelectedLaserItem(string pSelectedLaserItem)
        {
            if (Player.Settings.InGameSettings.selectedLaser.Equals(pSelectedLaserItem))
            {
                if (Player.Settings.Gameplay.quickSlotStopAttack && Player.Selected != null)
                {
                    ...
                    if (!Player.AttackManager.Attacking)
                    {
                        Player.SendCommand(AttackLaserRunCommand.write(Player.Id, Player.Selected.Id, -1, false, false));
