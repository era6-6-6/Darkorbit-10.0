namespace Darkorbit.Game.Objects.Players.Skills
{
    class AegisHpRepair : Skill
    {
        ...
        {
            var aegisIds = new List<int> { Ship.AEGIS, Ship.HAMMERCLAW, Ship.HAMMERCLAW_ULLRIN, Ship.HAMMERCLAW_FROZEN, Ship.HAMMERCLAW_NOBILIS, Ship.HAMMERCLAW_BANE, Ship.HAMMERCLAW_CARBONITE, Ship.HAMMERCLAW_LAVA, Ship.AEGIS_VETERAN, Ship.AEGIS_ELITE, Ship.HAMMERCLAW_TYRANNOS, Ship.HAMMERCLAW_PROMETHEUS };
