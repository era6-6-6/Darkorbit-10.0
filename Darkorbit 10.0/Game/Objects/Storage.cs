...
using Darkorbit.Game.Objects.Players.Skills;
...
namespace Darkorbit.Game.Objects
{
    ...
    internal class Storage
    {
        ...
        public UltimateBattleArena Uba = null;
        public UltimateBattleArenaLobby ubal = null;
        public bool LogoutUba = true;
        public bool waitUBA = false;
        public bool waitTDM = false;
        ...
        public bool SpaceballActive = false;

        public int oldShip = -1;
        public int oldDamage = -1;
        ...
        public void DeactivePLD8()
        {
            if (underPLD8)
            {
                ...
                if (Character is Player player)
                {
                    ...
                    player.SendPacket("0|n|fx|end|PLD_EFFECT|" + Character.Id + "");
                }

                Character.SendPacketToInRangePlayers("0|n|MAL|REM|" + Character.Id + "");
                Character.SendPacketToInRangePlayers("0|n|fx|end|PLD_EFFECT|" + Character.Id + "");
            }
        }
