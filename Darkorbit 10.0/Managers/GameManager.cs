...
namespace Darkorbit.Managers
{
    class GameManager
    {
        ...
        public static ConcurrentDictionary<int, bool> afkPlayers = new ConcurrentDictionary<int, bool>();
        public static ConcurrentDictionary<int, bool> playersInGalaxyGates = new ConcurrentDictionary<int, bool>();

        public async static void Restart(int seconds, string rason)
        {
            SendPacketToAll($"0|A|STD|{rason}");
