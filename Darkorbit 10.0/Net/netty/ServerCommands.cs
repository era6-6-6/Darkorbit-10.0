...
namespace Darkorbit.Net.netty
{
    class ServerCommands
    {
        ...
        public const String WarPointsED_HUNT_EVENT_UPDATE = "RHE";

        public const String WarPointsED_HUNT_EVENT_INFO = "NFO";

        public const String WarPointsED_HUNT_EVENT_END = "END";

        public const String WarPointsED_HUNT_EVENT_STATS_CLASS_PLAYER = "P";

        public const String WarPointsED_HUNT_EVENT_STATS_CLASS_CLAN = "C";

        public const String WarPointsED_HUNT_EVENT_TARGET_MATCH_CLASS_PLAYER = "P";

        public const String WarPointsED_HUNT_EVENT_TARGET_MATCH_CLASS_NPC = "N";
